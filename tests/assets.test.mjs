...
for(const id of ['mia','ren','tomo','shell'])test(`original ${id} export provides animation pivots, UV face and embedded resources`,async()=>{
 const b=await readFile(new URL(`../assets/characters/${id}.glb`,import.meta.url));

...
import {v7Script} from './script.mjs';
...
const replay=await response.json();let script=v7Script(replay),manifest=null;
...
async function draw(t){
  ...
  pose(t,city);town.setOpeningTreesVisible(t>=6.2);cafe.setTreesVisible(t>=6.2);

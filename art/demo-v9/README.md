...
```sh
node scripts/serve-demo-v9.mjs
```

In another terminal:

```sh
node --experimental-websocket scripts/render-demo-v9.mjs --preview
node scripts/build-demo-v9-audio.mjs
python3 scripts/mix-demo-v9-audio.py
node --experimental-websocket scripts/render-demo-v9.mjs
node scripts/finish-demo-v9.mjs
node scripts/verify-demo-v9.mjs
```

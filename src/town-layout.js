...
export const modernPlots=[
  {x:-7.5,z:33.5,height:8,phase:2,rotation:.12},
  {x:-5,z:40,height:12,phase:3,rotation:0},
  {x:5,z:40,height:10,phase:3,rotation:-.12},
];
...
export function workSpot(place,id){
  ...
  const d=offsets[id]||[0,0];return {x:p.x+d[0],z:p.z+d[1]};
}

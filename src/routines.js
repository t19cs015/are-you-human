...
export const routines={
 ...
 ren:[{label:'図書館で歩行制御の資料を読む',room:'library',point:[62.8,-.5],note:'平らな床の結果を、段差にも使っていた。テストを分けよう。',kind:'read'},{label:'ベンチで記録を読み返す',point:[4,2],note:'二万件ある。まず条件の同じ記録だけに絞ろう。',kind:'read'}],

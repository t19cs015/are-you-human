const views={shore:{label:"霧の水門",position:[35.2,1.68,50.6],look:[53,2.2,51]},margin:{label:"記憶の端",position:[0,1.68,86.9],look:[0,2.3,96]},canal:{label:'都市の水路',position:[-15,1.68,60.3],look:[-25,1.2,65]},shops:{label:'都市の店先',position:[-19.5,1.68,52],look:[-20,2,57]},heart:{label:'都市の心臓',position:[0,1.68,73.1],look:[0,4.5,82]},wind:{label:'風待ちの丘',position:[-34,1.68,15.1],look:[-34,4,9]},plaza:{label:'広場',position:[0,1.68,6.6],look:[0,1.6,-3]},cafe:{label:'カフェ',position:[-1.5,1.68,2.6],look:[-5.4,2,-4]},homes:{label:'住宅の入口',position:[6.7,1.68,.6],look:[10,1.9,-1]},road:{label:'中央への道',position:[0,1.68,14],look:[0,2.7,28.9]},central:{label:'中央',position:[0,1.68,24.5],look:[0,2.8,28.9]},memory:{label:'記憶の都市',position:[0,1.68,48.3],look:[0,3.3,72]},river:{label:'川辺',position:[-18,1.68,32.7],look:[-27,0,41.5]}};

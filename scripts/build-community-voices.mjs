...
import {episodeVoices} from '../src/episode-script.js';
import {communityLines as episodeLines} from '../src/community-rules.js';

if(!defaults.key)throw new Error('Set OPENAI_API_KEY in .env first.');
const directory=new URL('../assets/community/',import.meta.url);await mkdir(directory,{recursive:true});

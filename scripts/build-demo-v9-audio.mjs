...
import {v9Script} from '../art/demo-v9/script.mjs';

const root=fileURLToPath(new URL('../',import.meta.url)),dir=root+'data/film-v9/',rate=48000;
const replay=JSON.parse(await readFile(dir+'replay.json','utf8')),script=v9Script(replay);
...
await writeFile(dir+'audio-manifest.json',JSON.stringify({model:'gpt-4o-mini-tts',version:'9',duration:60,clips},null,2));await writeFile(dir+'script.json',JSON.stringify(script,null,2));

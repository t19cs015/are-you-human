...
// Usage: node --experimental-websocket scripts/render-demo-v6.mjs --preview
...
const build=fileURLToPath(new URL('../data/film-v6/',import.meta.url));await mkdir(build,{recursive:true});
const riverOnly=process.argv.includes('--river'),preview=process.argv.includes('--preview')||riverOnly,profile=await mkdtemp(join(tmpdir(),'ayh-v6-chrome-'));
...
try{
  ...
  const samples=riverOnly?[1300,1330,1343,1350]:[0,65,150,210,285,335,392,450,525,650,714,780,842,915,978,1080,1150,1200,1265,1285,1310,1323,1330,1340,1350,1360,1370,1383,1410,1455,1545,1635,1760];

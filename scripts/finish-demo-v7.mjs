...
const root=fileURLToPath(new URL('../',import.meta.url)),dir=root+'data/film-v7/',out=root+'exports/';await mkdir(out,{recursive:true});
const file=out+'are-you-human-demo-v7.mp4';
...
if(Math.abs(Number(p.format.duration)-60)>.04||v.width!==1920||v.height!==1080||v.nb_frames!=='1800'||a.channels!==2)throw new Error('V7 format validation failed');

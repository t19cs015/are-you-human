...
const root=fileURLToPath(new URL('../',import.meta.url)),dir=root+'data/film-v7/';
...
let source=dir+'master.wav';try{await access(root+'exports/are-you-human-demo-v7.mp4');source=root+'exports/are-you-human-demo-v7.mp4';}catch{}
execFileSync('ffmpeg',['-y','-v','error','-ss','6.5','-i',source,'-t','53.5','-ac','1',dir+'verification.wav']);
const form=new FormData();form.set('model','gpt-4o-mini-transcribe');form.set('language','en');form.set('file',new File([await readFile(dir+'verification.wav')],'demo-v7.wav',{type:'audio/wav'}));

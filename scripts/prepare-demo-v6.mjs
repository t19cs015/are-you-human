...
export const build=new URL('../data/film-v6/',import.meta.url);
...
export async function prepareV6(colliders){
  ...
  await writeFile(new URL('script.json',build),JSON.stringify(v6Script(result),null,2));

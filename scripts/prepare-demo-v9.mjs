...
export const build=new URL('../data/film-v9/',import.meta.url);
...
export async function prepareV9(colliders){
  ...
  await writeFile(new URL('script.json',build),JSON.stringify(v9Script(result),null,2));

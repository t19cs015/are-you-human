...
import {v8Script} from '../art/demo-v8/script.mjs';

export const build=new URL('../data/film-v8/',import.meta.url);
...
export async function prepareV8(colliders){
  ...
  await writeFile(new URL('script.json',build),JSON.stringify(v8Script(result),null,2));

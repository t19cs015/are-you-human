...
const root=fileURLToPath(new URL('../',import.meta.url)),dir=root+'data/film-v7/',rate=48000;
const replay=JSON.parse(await readFile(dir+'replay.json','utf8')),script=v7Script(replay);
